...
\newcommand{\imprimirbrazilabstract}{%
    ...
    \begin{resumo}[Resumo]
        ...
        passos na área e ainda não possuem proficiência em inglês. Dessa forma, o objetivo deste trabalho consiste em incentivar 
...
\newcommand{\imprimirenglishabstract}{%
    ...
    \begin{resumo}[Abstract]
        ...
        not yet proficient in reading English. Therefore, the aim of this study is to encourage the use of the Beecrowd platform among educators, 
