...
\newcommand{\imprimirbrazilabstract}{%
    ...
    \begin{resumo}[Resumo]
        ...
        O VPL é um módulo integrado ao Moodle e gerenciador de tarefas de programação, mas que apresenta problemas de interface e usabilidade. 
        ...
        passos na área e ainda não possuem proficiência em leitura em inglês. Dessa forma, o objetivo deste trabalho consiste em desenvolver 
        um plugin Moodle, com o propósito de integrar o Beecrowd ao Moodle, para aprimorar o ensino da programação nas salas de aula. Esse plugin 
        proporcionará um melhor controle das atividades e avaliações, além de facilitar o uso da plataforma para alunos e professores. \englishword{\showfont}
...
\newcommand{\imprimirenglishabstract}{%
    ...
    \begin{resumo}[Abstract]
        ...
        tools to support Information Technology and Computing courses, such as VPL. VPL is a Moodle-integrated module and programming task manager,
         but it has interface and usability problems. On the other hand, there are platforms not linked to Moodle that have an online judge for
          ...
          not yet proficient in reading English. Therefore, the aim of this study is to develop a Moodle plugin, with the purpose of integrating 
          Beecrowd into Moodle, in order to improve the teaching of programming in classrooms. This plugin will provide better control of activities 
          and assessments, as well as facilitating the use of the platform for students and teachers.
