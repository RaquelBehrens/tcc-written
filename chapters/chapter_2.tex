...
\section{UMA FERRAMENTA BASEADA EM JUÍZES ONLINE PARA APOIO ÀS ATIVIDADES DE PROGRAMAÇÃO DE COMPUTADORES NO MOODLE}
...
\begin{figure}[h!]
        \centering
         ...
         \label{fig:ModeloConceitual}
                \includegraphics[scale=0.3]{pictures/Rule_Based_Expert_System_arvore_decisao.png}
...
\begin{figure}[h!]
        \centering
         ...
         \label{fig:ModeloConceitual}
                \includegraphics[scale=0.3]{pictures/degree_planner_page_layout.png}
     \fonte{\cite[p.~305]{neildunstan}}
\end{figure}
...
\begin{figure}[h!]
        \centering
         ...
         \label{fig:ModeloConceitual}
                \includegraphics[scale=0.3]{pictures/degree_planner_client_server.png}
