...
\begin{table}[htb]
        \IBGEtab{%
          ...
          \midrule
          Possui Juiz Online	                        &  Sim	& Sim	& Sim	& Sim   \\ \midrule
          Fornece Feedback Imediato	                &  Sim	& Sim	& Sim	& Sim   \\ \midrule
          Criação Manual de Questões	                &  Não	& Sim	& Sim	& Sim   \\ \midrule
          Questões Prontas para Professores	        &  Sim	& Não	& Não	& Não   \\ \midrule
          Ajuste Manual de Resultados	                &  Não	& Sim	& Não	& Não   \\ \midrule
          Inserção Manual de Casos de Teste	        &  Não	& Sim	& Sim	& Sim   \\ \midrule
          Suporta Diversas Linguagens	                &  Sim	& Sim	& Sim	& Sim   \\ \midrule
          Pré-processamento de Submissões	        &  Não	& Não	& Não	& Sim   \\ \midrule
          Comentários de Testes Falhados	        &  Não	& Não	& Sim	& Não   \\ \midrule
          Prevenção de Plágio	                        &  Sim	& Não	& Sim	& Não   \\ 
          \bottomrule
        \end{tabular}%
        }{%
          \fonte{
