...
Na seção de desenvolvimento, é apresentado um diagrama UML, juntamente com requisitos funcionais e não funcionais, para definir uma arquitetura geral da integração proposta.
