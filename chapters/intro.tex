...
\begin{enumerate}[label=(\alph*)]
    ...
    \item  permitir ao professor criar listas de exercícios e competições pelo Moodle; 
    \item  permitir ao aluno submeter uma solução via Moodle ou Beecrowd; 
    \item  permitir ao professor visualizar o progresso de cada aluno (geral e de acordo com cada lista de exercícios); 
    \item  permitir ao aluno visualizar seu próprio progresso (geral e de acordo com cada lista de exercícios, e de cada exercício); 
    ...
    \item  permitir o envio de feedback da resposta do Beecrowd ao aluno diretamente no Moodle.
\end{enumerate}
